...
const { NativeModule } = require('ts-node/dist-raw/node-nativemodule');
const { pathToFileURL, fileURLToPath } = require('url');
const fs = require('fs');
const path = require('path');
const { sep } = path;
const { internalModuleStat } = require('ts-node/dist-raw/node-internalBinding-fs');
const packageJsonReader = require('ts-node/dist-raw/node-internal-modules-package_json_reader');
const {
  cjsConditions,
} = require('ts-node/dist-raw/node-internal-modules-cjs-helpers');
...
const {createErrRequireEsm} = require('ts-node/dist-raw/node-internal-errors');
const {
  codes: {
    ERR_INVALID_MODULE_SPECIFIER,
  },
} = require('ts-node/dist-raw/node-internal-errors');

const {
  CHAR_FORWARD_SLASH,
} = require('ts-node/dist-raw/node-internal-constants');
...
/**
 * @param {{
 *   nodeEsmResolver: ReturnType<typeof import('ts-node/dist-raw/node-internal-modules-esm-resolve').createResolve>,
