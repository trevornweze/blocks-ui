...
const cjs_resolve_hooks_1 = require("ts-node/dist/cjs-resolve-hooks");
const node_module_type_classifier_1 = require("ts-node/dist/node-module-type-classifier");
const file_extensions_1 = require("ts-node/dist/file-extensions");
const ts_transpile_module_1 = require("ts-node/dist/ts-transpile-module");
...
let assertScriptCanLoadAsCJS = engineSupportsPackageTypeField
    ? require('ts-node/dist-raw/node-internal-modules-cjs-loader').assertScriptCanLoadAsCJSImpl
    : () => {
        /* noop */
    };
/**
...
function createFromPreloadedConfig(foundConfigResult) {
    ...
    const getNodeEsmResolver = (0, util_1.once)(() => require('ts-node/dist-raw/node-internal-modules-esm-resolve').createResolve({
        extensions,
        preferTsExts: options.preferTsExts,
        tsNodeExperimentalSpecifierResolution: options.experimentalSpecifierResolution,
    }));
    const getNodeEsmGetFormat = (0, util_1.once)(() => require('ts-node/dist-raw/node-internal-modules-esm-get_format').createGetFormat(options.experimentalSpecifierResolution, getNodeEsmResolver()));
    const getNodeCjsLoader = (0, util_1.once)(() => require('ts-node/dist-raw/node-internal-modules-cjs-loader').createCjsLoader({
        extensions,
        preferTsExts: options.preferTsExts,
