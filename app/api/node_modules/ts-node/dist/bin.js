...
const node_internal_modules_cjs_helpers_1 = require("ts-node/dist-raw/node-internal-modules-cjs-helpers");
...
function phase4(payload) {
    ...
    if (executeEntrypoint) {
        if (payload.isInChildProcess &&
            ...
            require('ts-node/dist-raw/runmain-hack.js').run(entryPointPath);
        }
        else {
            Module.runMain();
        }
